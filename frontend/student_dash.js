...
const displayCourses = (courses) => {
    ...
    courses?.forEach((course) => {   
        ...
        div.innerHTML = `
            ...
            <button class="btn detail-btn"><a target="_blank" href="student_courseDetails.html?courseId=${course.id}" style="color: white; text-decoration: none;">Details</a> </button>
        `;
